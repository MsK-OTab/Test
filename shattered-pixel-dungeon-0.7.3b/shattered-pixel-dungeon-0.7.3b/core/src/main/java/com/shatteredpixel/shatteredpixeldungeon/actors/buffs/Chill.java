...
public class Chill extends FlavourBuff {
	...
	public boolean attachTo(Char target) {
		...
		if( target instanceof Hero && ((Hero)target).belongings.armor != null && ((Hero)target).belongings.armor.hasGlyph(Refrigeration.class, target) ) {
			Buff.affect( target, Refrigeration.FrozenShield.class );
		}
