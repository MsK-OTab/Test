...
public class ItemSpriteSheet {
	...
	public static final int GREAVE_HOLDER   = PLACEHOLDERS+3;
	public static final int MISSILE_HOLDER  = PLACEHOLDERS+4;
	public static final int WAND_HOLDER     = PLACEHOLDERS+5;
	public static final int AMULET_HOLDER   = PLACEHOLDERS+6;
	public static final int RING_HOLDER     = PLACEHOLDERS+7;
	public static final int ARTIFACT_HOLDER = PLACEHOLDERS+8;
	public static final int FOOD_HOLDER     = PLACEHOLDERS+9;
	public static final int BOMB_HOLDER     = PLACEHOLDERS+10;
	public static final int POTION_HOLDER   = PLACEHOLDERS+11;
	public static final int SEED_HOLDER     = PLACEHOLDERS+12;
	public static final int SCROLL_HOLDER   = PLACEHOLDERS+13;
	public static final int STONE_HOLDER    = PLACEHOLDERS+14;
	public static final int CATA_HOLDER     = PLACEHOLDERS+15;
	public static final int ELIXIR_HOLDER   = PLACEHOLDERS+16;
	public static final int SPELL_HOLDER    = PLACEHOLDERS+17;
	static{
		assignItemRect(SOMETHING,       8,  13);
		assignItemRect(WEAPON_HOLDER,   14, 14);
		assignItemRect(ARMOR_HOLDER,    14, 12);
		assignItemRect(GREAVE_HOLDER,   16, 16);
		assignItemRect(MISSILE_HOLDER,  15, 15);
		assignItemRect(WAND_HOLDER,     14, 14);
		assignItemRect(AMULET_HOLDER,   13, 16);
	...
	private static final int UNCOLLECTIBLE  =                               xy(9, 2);   //16 slots
	...
	public static final int ORB             = SINGLE_USE+15;
	static{
	...
	public static final int SWORD_TIER1     = WEP_TIER1+0;
	public static final int DAGGER          = WEP_TIER1+1;
	public static final int CUDGEL          = WEP_TIER1+2;
	public static final int AXE_TIER1       = WEP_TIER1+3;
	public static final int GLOVES          = WEP_TIER1+4;
	public static final int POLEARM_TIER1   = WEP_TIER1+5;
	public static final int STAFF_TIER1     = WEP_TIER1+6;
	public static final int MAGES_STAFF     = WEP_TIER1+7;
	static{
		assignItemRect(DAGGER,          12, 13);
		assignItemRect(CUDGEL,          14, 14);
	...
	public static final int HAND_AXE        = WEP_TIER2+3;
	public static final int UNARMED_TIER2   = WEP_TIER2+4;
	public static final int SPEAR           = WEP_TIER2+5;
	public static final int STAFF_TIER2     = WEP_TIER2+6;
	static{
	...
	public static final int SCIMITAR        = WEP_TIER3+0;
	public static final int SHORT_TIER3     = WEP_TIER3+1;
	public static final int FLAIL           = WEP_TIER3+2;
	public static final int BATTLE_AXE      = WEP_TIER3+3;
	public static final int TONFA           = WEP_TIER3+4;
	public static final int POLEARM_TIER3   = WEP_TIER3+5;
	public static final int QUARTERSTAFF    = WEP_TIER3+6;
	public static final int CROSSBOW        = WEP_TIER3+7;
	static{
		assignItemRect(SCIMITAR,        13, 16);
		assignItemRect(FLAIL,           15, 12);
		assignItemRect(BATTLE_AXE,      15, 15);
		assignItemRect(TONFA,           16, 15);
	...
	public static final int RAPIER          = WEP_TIER4+1;
	public static final int MORNINGSTAR     = WEP_TIER4+2;
	public static final int AXE_TIER4       = WEP_TIER4+3;
	public static final int UNARMED_TIER4   = WEP_TIER4+4;
	public static final int HALBERD         = WEP_TIER4+5;
	public static final int STAFF_TIER4     = WEP_TIER4+6;
	public static final int URUMI           = WEP_TIER4+7;
	static{
		assignItemRect(LONGSWORD,       15, 15);
		assignItemRect(RAPIER,          15, 15);
		assignItemRect(MORNINGSTAR,     16, 16);
		assignItemRect(HALBERD,         16, 16);
		assignItemRect(URUMI,           16, 14);
	}

	private static final int WEP_TIER5      =                               xy(1, 9);   //8 slots
	public static final int SWORD_TIER5     = WEP_TIER5+0;
	public static final int SHORT_TIER5     = WEP_TIER5+1;
	public static final int WAR_HAMMER      = WEP_TIER5+2;
	public static final int GREATAXE        = WEP_TIER5+3;
	public static final int GAUNTLETS       = WEP_TIER5+4;
	public static final int GLAIVE          = WEP_TIER5+5;
	public static final int MONKS_SPADE     = WEP_TIER5+6;
	static{
		assignItemRect(WAR_HAMMER,  16, 16);
		assignItemRect(GREATAXE,    12, 16);
		assignItemRect(GAUNTLETS,   13, 15);
		assignItemRect(GLAIVE,      16, 16);
		assignItemRect(MONKS_SPADE, 16, 16);
	}
	...
	private static final int WANDS              =                           xy(1, 13);  //16 slots
	...
	private static final int AMULETS            =                           xy(1, 14); //16 slots
	public static final int AMULET_BERYL        = AMULETS+0;
	public static final int AMULET_CITRINE      = AMULETS+1;
//	public static final int AMULET_AQUAMARINE   = AMULETS+2;
	public static final int AMULET_PLATINUM     = AMULETS+3;
	public static final int AMULET_SILVER       = AMULETS+4;
	public static final int AMULET_JASPER       = AMULETS+5;
	public static final int AMULET_BRASS        = AMULETS+6;
//	public static final int AMULET_CRYSTAL      = AMULETS+7;
//	public static final int AMULET_ZIRCONIUM    = AMULETS+8;
	static{
		for (int i = AMULETS; i < AMULETS+16; i++) {assignItemRect(i, 13, 16);}
	assignItemRect(AMULET_PLATINUM,  13, 14);
	}
...
//	public static final int RING_DIAMOND    = RINGS+11;
	...
	public static final int CLEANSE         = SPELLS+13;
	static{
