...
import com.shatteredpixel.shatteredpixeldungeon.items.amulets.Amulet;
...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			WEP_T3.probs = new float[]{ 6, 5, 5, 4, 3, 3 };
			...
			WEP_T4.probs = new float[]{ 6, 5, 4, 4, 3 };
			...
			WEP_T5.probs = new float[]{ 6, 5, 5, 5, 3 };
...
//				return item != null ? item : random(Category.RING);
	...
	public static Amulet randomAmulet() {
		try{
