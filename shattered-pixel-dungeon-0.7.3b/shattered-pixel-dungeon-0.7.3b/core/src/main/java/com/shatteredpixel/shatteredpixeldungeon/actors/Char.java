...
public abstract class Char extends Actor {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (bundle.contains( "SHLD" )){
			...
			ShieldBuff buff = buff(Refrigeration.FrozenShield.class);
	...
	protected void spend( float time ) {
		...
		if (buff( Slow.class ) != null) {
			...
			//slowed and chilled do not stack
				...
				&& ((Hero)this).belongings.armor != null
				&& ((Hero)this).belongings.armor.hasGlyph( Refrigeration.class, this )) {
			timeScale += 0 ;
		} else if (buff( Chill.class ) != null) {
		...
		if( this instanceof Hero && ((Hero)this).belongings.armor != null && ((Hero)this).belongings.armor.hasGlyph(HeatEngine.class, this)) {
			timeScale *= HeatEngine.EngineOperate.speedBonus();
		}
	...
	public enum Property{
		...
		INORGANIC ( new HashSet<Class>(),
				new HashSet<Class>( Arrays.asList(Bleeding.class, ToxicGas.class, Poison.class, Poisonous.class) )),
