...
public class WndBag extends WndTabbed {
	...
	public WndBag( Bag bag, Listener listener, Mode mode, String title ) {
		...
		nRows = (int)Math.ceil((Belongings.BACKPACK_SIZE + 5/*=equipable slots*/) / (float)nCols);
	...
	protected void placeItems( Bag container ) {
		...
		placeItem( stuff.amulet != null ? stuff.amulet : new Placeholder( ItemSpriteSheet.AMULET_HOLDER) );
		...
		// Free Space
		while ((count - 5/*=equipable slots*/) < container.size) {
			placeItem( null );
		}
	}
