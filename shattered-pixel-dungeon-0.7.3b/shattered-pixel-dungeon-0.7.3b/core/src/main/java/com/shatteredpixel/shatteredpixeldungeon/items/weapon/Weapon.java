...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.AntiEntropic;
...
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.curseenchantments.Flat;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.curseenchantments.Gambling;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.curseenchantments.Peaceful;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.curseenchantments.Precise;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.curses.curseenchantments.Thermodynamic;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Blazing;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Blocking;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Chilling;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Draining;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Kinetic;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Elastic;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Grim;
import com.shatteredpixel.shatteredpixeldungeon.items.weapon.enchantments.Poisonous;
...
abstract public class Weapon extends KindOfWeapon {
	...
	public static abstract class Enchantment implements Bundlable {
		...
		private static final Class<?>[] common = new Class<?>[]{
				Blazing.class, Chilling.class, Kinetic.class, Vorpal.class};
		
		private static final Class<?>[] uncommon = new Class<?>[]{
				Blocking.class, Elastic.class, Poisonous.class,
				Projecting.class, Shocking.class, Unstable.class };
		
		private static final Class<?>[] rare = new Class<?>[]{
				Draining.class, Grim.class, Vampiric.class};
		...
		private static final Class<?>[] curses = new Class<?>[]{
				/*Annoying.class, */ AntiEntropic.class, Displacing.class, Exhausting.class, Fragile.class,
				Sacrificial.class, Wayward.class, Polarized.class, Friendly.class
		};

		public static Map< Class<? extends Enchantment>,Enchantment > toUncursed = new HashMap<>();
		static {
			toUncursed.put( AntiEntropic.class, new Thermodynamic() );
			toUncursed.put( Displacing.class, new Grim() );
			toUncursed.put( Exhausting.class, new Draining() );
			toUncursed.put( Fragile.class, new Flat() );
			toUncursed.put( Sacrificial.class, new Vampiric() );
			toUncursed.put( Wayward.class, new Precise() );
			toUncursed.put( Polarized.class, new Gambling() );
			toUncursed.put( Friendly.class, new Peaceful() );
		}
