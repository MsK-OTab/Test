...
public class Heap implements Bundlable {
	...
	public void open( Hero hero ) {
		...
		if (type != Type.MIMIC) {
			type = Type.HEAP;
			ArrayList<Item> bonus = AmuletOfWealth.tryForBonusDrop(hero, 1);
...
//					return Messages.get(this, "crystal_chest_desc", Messages.get(this, "artifact") );
				if (peek() instanceof Amulet)
					return Messages.get(this, "crystal_chest_desc", Messages.get(this, "amulet") );
