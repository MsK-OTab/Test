...
import com.shatteredpixel.shatteredpixeldungeon.items.Orb;
...
public class Hero extends Char {
	...
	public int attackSkill( Char target ) {
		...
		if (wep != null) {
			if(((Weapon) wep).hasEnchant(Precise.class, this)) {
	...
	public int drRoll() {
		...
		dr += RingOfTenacity.drBonus( this );
	...
	public float speed() {
		...
		speed *= AmuletOfHaste.speedMultiplier(this);
	...
	public float stealth() {
		...
		stealth *= RingOfStealth.stealthMultiplier( this );
	...
	public boolean isImmune(Class effect) {
		if ( effect == Frost.class
				...
				&& belongings.armor.hasGlyph(Refrigeration.class, this)){
			return true;
		}
	...
	public boolean search( boolean intentional ) {
		...
		int distance = 1;
		if (heroClass == HeroClass.ROGUE) { distance += 1; }
		distance += AmuletOfDetection.detectionBonus( this );
				...
				if (fieldOfView[p] && p != pos) {
					...
					if (Dungeon.level.secret[p]){
						...
						//unintentional trap detection scales from 40% at floor 0 to 30% at floor 25
							...
							chance += 0.05f * AmuletOfDetection.detectionBonus( this );
