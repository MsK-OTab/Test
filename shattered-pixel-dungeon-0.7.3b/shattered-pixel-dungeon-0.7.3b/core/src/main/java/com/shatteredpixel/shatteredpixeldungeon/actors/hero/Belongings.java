...
import static com.shatteredpixel.shatteredpixeldungeon.actors.mobs.npcs.Ghost.Quest.armor;
...
public class Belongings implements Iterable<Item> {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		amulet = (Amulet) bundle.get(AMULET);
		if (amulet != null) {
	...
	public void uncurseEquipped() {
		ScrollOfRemoveCurse.uncurse( owner, armor, weapon, amulet, misc1, misc2 );
	}
	...
	private class ItemIterator implements Iterator<Item> {
		...
		private Item[] equipped = {weapon, armor, amulet, misc1, misc2};
