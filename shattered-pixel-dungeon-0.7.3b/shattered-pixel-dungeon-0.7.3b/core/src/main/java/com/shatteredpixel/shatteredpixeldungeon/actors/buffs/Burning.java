		...
		if (target.isAlive() && !target.isImmune(getClass())) {
			...
			if (target instanceof Hero) {
				...
				if (hero.belongings.armor != null && hero.belongings.armor.hasGlyph(HeatEngine.class, hero)){
					Buff.affect(target, HeatEngine.EngineOperate.class);
			...
			HeatEngine.EngineOperate engineOperate = target.buff(HeatEngine.EngineOperate.class);
			if (engineOperate != null)
				engineOperate.startDecay();
