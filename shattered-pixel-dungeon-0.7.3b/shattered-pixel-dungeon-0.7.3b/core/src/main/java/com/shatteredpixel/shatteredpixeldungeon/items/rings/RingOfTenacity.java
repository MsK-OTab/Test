...
public class RingOfTenacity extends Ring {
	...
	public static float damageMultiplier( Char t ){
		...
		return (float)Math.pow(0.87, getBonus( t, Tenacity.class)*((float)(t.HT - t.HP)/t.HT));
	}

	public static int drBonus (Char target) {return ( 2 + getBonus( target, Tenacity.class) ) / 2 ;}
