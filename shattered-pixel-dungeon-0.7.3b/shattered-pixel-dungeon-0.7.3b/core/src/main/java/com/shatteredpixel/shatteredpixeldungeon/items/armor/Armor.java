...
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.Clanging;
...
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Cloning;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Dodge;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Noxious;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Recovery;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Roaring;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.curses.curseglyphs.Thriving;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.glyphs.Adaptation;
...
import com.shatteredpixel.shatteredpixeldungeon.items.armor.glyphs.Refrigeration;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.glyphs.HeatEngine;
import com.shatteredpixel.shatteredpixeldungeon.items.armor.glyphs.Kinesis;
...
//		armor can be kept in bones between runs, the seal cannot.
	...
	public float evasionFactor( Char owner, float evasion ){
		...
		if (hasGlyph(Viscosity.class, owner) &&  !((Viscosity)glyph).testingEvasion()){
			return 0;
		}

		if (hasGlyph(Adaptation.class, owner) && owner.flying ) { evasion += 1.2 * level(); }
	...
	public float speedFactor( Char owner, float speed ){
		...
		} else */if ( (hasGlyph(Adaptation.class, owner)) && Dungeon.level.water[owner.pos]){
...
//		+2: 5%  (1/20)
	...
	public static abstract class Glyph implements Bundlable {
		...
		private static final Class<?>[] common = new Class<?>[]{
				Obfuscation.class,/* Swiftness.class,*/ Viscosity.class, Potential.class, Kinesis.class };
		
		private static final Class<?>[] uncommon = new Class<?>[]{
				/*Brimstone.class, Stone.class, Entanglement.class, Repulsion.class, Camouflage.class, Flow.class*/
				Adaptation.class, Affection.class, AntiMagic.class, Thorns.class };
		
		private static final Class<?>[] rare = new Class<?>[]{
				HeatEngine.class, Refrigeration.class, Resonance.class };
		...
		private static final Class<?>[] curses = new Class<?>[]{
				/*AntiEntropy.class,*/ Clanging.class, Corrosion.class, Displacement.class, Metabolism.class,
				Multiplicity.class, Stench.class, Overgrowth.class/*, Bulk.class*/
		};

		public static Map< Class<? extends Glyph>,Glyph > toUncursed = new HashMap<>();
		static {
			toUncursed.put( Clanging.class, new Roaring() );
			toUncursed.put( Corrosion.class, new Noxious() );
			toUncursed.put( Displacement.class, new Dodge() );
			toUncursed.put( Metabolism.class, new Recovery() );
			toUncursed.put( Multiplicity.class, new Cloning() );
			toUncursed.put( Stench.class, new Noxious() );
			toUncursed.put( Overgrowth.class, new Thriving() );
		}
