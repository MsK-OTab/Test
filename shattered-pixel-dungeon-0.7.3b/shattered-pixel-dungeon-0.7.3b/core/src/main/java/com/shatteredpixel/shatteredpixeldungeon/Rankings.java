...
public enum Rankings {
	...
	public void saveGameData(Record rec){
		...
		//include worn rings
		if (belongings.amulet != null) belongings.backpack.items.add(belongings.amulet);
		Amulet.saveSelectively(handler, belongings.backpack.items);
