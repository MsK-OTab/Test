...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		case 6:
			itemsToSpawn.add( (Random.Int( 2 ) == 0 ? new Mace().identify() : new HandAxe()).identify() );
		...
		case 11:
			itemsToSpawn.add( (Random.Int( 2 ) == 0 ? new Flail().identify() : new BattleAxe()).identify() );
			itemsToSpawn.add( Random.Int( 2 ) == 0 ?
		...
		case 16:
			itemsToSpawn.add( (Random.Int( 2 ) == 0 ? new Morningstar().identify() : new Halberd()).identify() );
			itemsToSpawn.add( Random.Int( 2 ) == 0 ?
		...
		case 21:
			itemsToSpawn.add( Random.Int( 2 ) == 0 ? new WarHammer().identify() : new Glaive().identify() );
			itemsToSpawn.add( Random.Int(2) == 0 ?
		...
		switch (Random.Int(10)){
			...
			case 1:
				...
				break;
			case 2:
				rare = Generator.random( Generator.Category.AMULET );
				break;
			default:
				rare = new Stylus();
		}
